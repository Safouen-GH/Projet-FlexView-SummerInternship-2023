 ...
 */
class getDebug_Serializer_Encoder_JsonService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'debug.serializer.encoder.json' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['debug.serializer.encoder.json'] = new \Symfony\Component\Serializer\Debug\TraceableEncoder(($container->privates['debug.serializer.encoder.json.inner'] ?? ($container->privates['debug.serializer.encoder.json.inner'] = new \Symfony\Component\Serializer\Encoder\JsonEncoder(NULL, NULL))), ($container->privates['serializer.data_collector'] ?? ($container->privates['serializer.data_collector'] = new \Symfony\Component\Serializer\DataCollector\SerializerDataCollector())));
    }
}
