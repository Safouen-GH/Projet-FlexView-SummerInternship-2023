...
class getMaker_GeneratorService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['maker.generator'] = new \Symfony\Bundle\MakerBundle\Generator(($container->privates['maker.file_manager'] ?? $container->load('getMaker_FileManagerService')), 'App', NULL, ($container->privates['maker.template_component_generator'] ?? ($container->privates['maker.template_component_generator'] = new \Symfony\Bundle\MakerBundle\Util\TemplateComponentGenerator())));
    }
}
