 ...
 */
class getDebug_Serializer_Normalizer_MimeMessageService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'debug.serializer.normalizer.mime_message' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a = ($container->privates['debug.serializer.normalizer.mime_message.inner'] ?? $container->load('getDebug_Serializer_Normalizer_MimeMessage_InnerService'));

        if (isset($container->privates['debug.serializer.normalizer.mime_message'])) {
            return $container->privates['debug.serializer.normalizer.mime_message'];
        }

        return $container->privates['debug.serializer.normalizer.mime_message'] = new \Symfony\Component\Serializer\Debug\TraceableNormalizer($a, ($container->privates['serializer.data_collector'] ?? ($container->privates['serializer.data_collector'] = new \Symfony\Component\Serializer\DataCollector\SerializerDataCollector())));
    }
}
